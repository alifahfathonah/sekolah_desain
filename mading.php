			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="card text-left">
					  <div class="card-body">
					  	<p style="font-size: 9px; background-color: orange; width: 200px; border-radius: 5px; padding-left: 10px;"><em><?=$row['created_at']?></em> - oleh <b><em><?=$row['name']?></em></b></p>
					    <h5 class="card-title"><?=$row['title']?></h5>
					    <p class="card-text"><?php echo substr($row['content'], 0, 100)?></p>
					    <a class="btn btn-sm btn-primary" href="detail_mading.php?mading_id=<?php echo $row['id']?>" style="color: #fff;">Readmore</a>
					  </div>
					</div>
